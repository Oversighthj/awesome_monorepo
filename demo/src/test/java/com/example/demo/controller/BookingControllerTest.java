...
class BookingControllerTest {
    ...
    void bookTransport_ValidPayload_ReturnsBooking() throws Exception {
        // given
        var dto = new com.example.demo.dto.TransportBookingDTO();
        dto.setFlightId("FL123");
        dto.setUserId("USR1");
        dto.setSeatCount(2);

        var mockBooking = new com.example.demo.entity.BookingEntity();
        ...
        mockBooking.setBookingTime(java.time.LocalDateTime.of(2025, 4, 30, 15, 30));
