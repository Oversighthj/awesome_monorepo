...
/**
 * Global exception handler for the application, providing RFC 7807-compliant ProblemDetail responses.
 */
@RestControllerAdvice
public class GlobalExceptionHandler {

    /**
     * Handle validation errors on method arguments (e.g. @Valid request bodies).
     * Returns HTTP 400 with all field validation errors listed.
     */
    ...
    /**
     * Handle constraint violation exceptions (e.g. from @Validated inputs).
     * Returns HTTP 400 with all constraint violations listed.
     */
    ...
    /**
     * Handle custom application exceptions (e.g. entity not found).
     * Returns HTTP 404 with the exception message as detail.
     */
     ...
     * Returns HTTP 500 with a generic error detail.
     */
