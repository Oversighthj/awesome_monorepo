...
class BookingsApi {
  ...
  /// Returns a [Future] containing a [Response] with a [BookingDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookingDTO>> getBooking({ 
    ...
    final _path = r'/bookings/{bookingId}'.replaceAll('{' r'bookingId' '}', encodeQueryParameter(_serializers, bookingId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<BookingDTO>>> listBookings({ 
    int? userId,
